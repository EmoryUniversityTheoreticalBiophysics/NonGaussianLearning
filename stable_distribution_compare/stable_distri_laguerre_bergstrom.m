...
% Generates symmetric stable distributions.

% sd_lb represents stable distribution with the laguerre-bergstrom method.
% alpha1, gamma1, and delta1 are parameters of the symmetric stable distribution.
% l is the resolution, and L is the cut-off point. Usually, l is chosen to
% be 1, and the range of the distribution is [-L,L].
...
% In folder, stable_distribution_compare, I compare stable distributions
...
% The conditions below are empirical, and they were chosen in this way to
...
% N is the number of terms in Bergstrom expansion.
n = 1:20; 
...
% l96_r represents root vector. l96_w represents weight vector. 
